...
# `true` is set.
export RELEASE_VERSIONS='release_versions=[{"0.1.0"=true},{"0.1.1"=false},]'
export CONSUL_VERSIONS='consul_versions=["1.2.3","1.2.3-ent",]'
export VAULT_VERSIONS='vault_versions=["0.11.3","0.11.3-ent",]'
export NOMAD_VERSIONS='nomad_versions=["0.8.6","0.8.6-ent",]'
