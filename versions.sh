...
# as well.
export RELEASE_VERSIONS='release_versions=["2.1.0","0.1.1",]'
export CONSUL_VERSIONS='consul_versions=["2.2.0","1.2.0-ent",]'
export VAULT_VERSIONS='vault_versions=["2.10.3","0.10.3-ent",]'
export NOMAD_VERSIONS='nomad_versions=["2.8.4","0.8.4-ent",]'
