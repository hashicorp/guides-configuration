...
# `true` is set.
export RELEASE_VERSIONS='release_versions=[{"0.1.0"=true},]'
export CONSUL_VERSIONS='consul_versions=["1.2.3",]'
export VAULT_VERSIONS='vault_versions=["0.11.3",]'
export NOMAD_VERSIONS='nomad_versions=["0.8.6",]'
